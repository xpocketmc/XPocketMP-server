...
$pattern = '/\buse\s+pocketmine\s+askAsyncTask;/'; // Menangkap bentuk seperti `use pocketmine\task\AsyncTask;`
$replacement = 'use pocketmine\task\AsyncTask;'; // Perbaikan yang benar
