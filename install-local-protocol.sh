...
echo "--- This allows you to perform integration tests using xpocketmp-MP, without immediately publishing new versions of these libraries."
...
composer require xpocketmp/bedrock-protocol:*@dev xpocketmp/bedrock-data:*@dev xpocketmp/bedrock-block-upgrade-schema:*@dev xpocketmp/bedrock-item-upgrade-schema:*@dev
