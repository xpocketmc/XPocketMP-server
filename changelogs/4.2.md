...
- Now using `xpocketmp/bedrock-protocol` [`8.0.1`](https://github.com/pmmp/BedrockProtocol/releases/tag/8.0.1%2Bbedrock-1.18.10).
...
## General
- Added lots more documentation (in comments) about the `aliases` section in `xpocketmp.yml`. You can read about this feature in the `aliases` section of the [updated `xpocketmp.yml` template](/resources/xpocketmp.yml).
