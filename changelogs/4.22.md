...
- [4.21.0](https://github.com/pmmp/xpocketmp-MP/blob/4.22.0/changelogs/4.21.md#4210) - PHP 8.1 minimum version, minor performance improvements
...
- Replaced workaround for an old teleporting client bug:
  ...
  - See issues [#4394](https://github.com/pmmp/xpocketmp-MP/issues/4394) and [#5810](https://github.com/pmmp/xpocketmp-MP/issues/5810) for more details.
