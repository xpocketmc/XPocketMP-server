...
This is the first beta in the 1.4 series. This is a complete rewrite of xpocketmp-MP, so only plugins developed for this new API will work.
...
- Infinite worlds
- Multithreading!
- New efficient threaded networking library, [RakLib](https://github.com/xpocketmp/RakLib)
...
- Advanced settings on xpocketmp.yml file!
...
- Added settings.query-plugins to xpocketmp.yml
...
- Added worlds directive to xpocketmp.yml to load extra worlds or use a plugin-provided generator
...
- Removed PHP_VERSION constant on xpocketmp namespace
...
- Reactivated chunk ticking _(can be disabled via xpocketmp.yml)_
- Beds! Furnaces!
...
- Moved spl to [xpocketmp-SPL](https://github.com/xpocketmp/xpocketmp-MP)
...
**Main features:**
- Added non-threaded chunk generation, toggleable on xpocketmp.yml
- Added Liquid flow
- Fixed Double Chests
...
This is the first stable build of xpocketmp-MP 1.4. Lots of changes have happened since 1.3.12, and they won't be detailed here. You can find them on the release list here on GitHub.
