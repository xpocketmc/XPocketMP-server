...
## General
- Docker images for xpocketmp-MP are now published on [GitHub Container Registry](https://github.com/pmmp/xpocketmp-MP/pkgs/container/xpocketmp-mp). The Docker Hub images will stop being maintained in the future.
