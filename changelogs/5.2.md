...
- Regenerated `xpocketmp\data\bedrock\item\ItemTypeNames` for Bedrock 1.20 (BC breaking, some item names have changed).
...
- [4.22.3](https://github.com/pmmp/xpocketmp-MP/blob/4.22.3/changelogs/4.22.md#4223) - Fixes for some crash issues
