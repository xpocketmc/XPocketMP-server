...
In Minecraft: PE 0.7.4 you can add External servers directly. [How to add servers](https://github.com/xpocketmp/xpocketmp-MP/wiki/How-to-add-servers)
...
Starting with this release, all xpocketmp-MP versions will be given a codename. This one received the codename 「甘いビートルート」_(Amai Beetroot)_.
...
For more information, check the [complete changelog](https://github.com/xpocketmp/xpocketmp-MP/compare/Alpha_1.3.10...Alpha_1.3.11).
...
**Changelog:**
- New set-up wizard in multiple languages. Help translate it to more languages on http://translate.xpocketmp.net/
...
If you are on Linux, you can use `wget -q -O - http://cdn.xpocketmp.net/installer.sh | bash -s - -v Alpha_1.3.12` to update. If you are on a MacOS, use `curl -sL http://cdn.xpocketmp.net/installer.sh | bash -s - -v Alpha_1.3.12`