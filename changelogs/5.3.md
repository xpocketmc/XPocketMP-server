...
- [5.2.0](https://github.com/pmmp/xpocketmp-MP/blob/5.2.0/changelogs/5.2.md#520)

## Included releases
**This release includes changes from the following releases:**
- [4.23.0](https://github.com/pmmp/xpocketmp-MP/blob/4.23.0/changelogs/4.23.md#4230) - Support for Minecraft: Bedrock Edition 1.20.10

## Internals
- `BlockTypeNames`, `BlockStateNames`, `BlockStateStringValues` and `ItemTypeNames` in the `xpocketmp\data\bedrock` package have BC-breaking changes to accommodate Bedrock 1.20.10.
...
## Included releases
**This release includes changes from the following releases:**
- [4.23.1](https://github.com/pmmp/xpocketmp-MP/blob/4.23.1/changelogs/4.23.md#4231) - Security fixes
...
## Included releases
**This release includes changes from the following releases:**
- [4.23.2](https://github.com/pmmp/xpocketmp-MP/blob/4.23.2/changelogs/4.23.md#4232) - Fix for `sandboxId`-related login errors
...
## Included releases
**This release includes changes from the following releases:**
- [4.23.3](https://github.com/pmmp/xpocketmp-MP/blob/4.23.3/changelogs/4.23.md#4233) - Various bug fixes
...
- Added a workaround for PM4 worlds with chunks corrupted by [Refaltor77/CustomItemAPI](https://github.com/Refaltor77/CustomItemAPI).
  - While this was not the fault of xpocketmp-MP itself, a significant number of users were affected by this problem.
...
## Included releases
This release includes changes from the following releases:
- [4.23.4](https://github.com/pmmp/xpocketmp-MP/blob/4.23.4/changelogs/4.23.md#4234) - Item entity lag fix
