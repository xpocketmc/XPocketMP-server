...
- Fixed permissions `xpocketmp.command.ban.list`, `xpocketmp.command.difficulty`, `xpocketmp.command.whitelist.enable` and `xpocketmp.command.whitelist.disable` always being granted to operators.
