 ...
 */
function buildPhar(string $pharPath, string $basePath, array $includedPaths, array $metadata, string $stub, int $signatureAlgo = \Phar::SHA1, ?int $compression = null): void{
...
function main() : void{
	...
	if(isset($opts["out"])){
		...
		$pharPath = getcwd() . DIRECTORY_SEPARATOR . "XPocketMP.phar";
	}
	foreach(buildPhar(
		$pharPath,
