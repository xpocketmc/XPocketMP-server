...
final class BlockStateToObjectDeserializer implements BlockStateDeserializer{
	...
	private function registerSimpleDeserializers() : void{
		...
		$this->mapSimple(Ids::CLOSED_EYEBLOSSOM, fn() => Blocks::EYEBLOSSOM());
		...
		$this->mapSimple(Ids::CREAKING_HEART, fn() => Blocks::CREAKING_HEART());
		...
		$this->mapSimple(Ids::OPEN_EYEBLOSSOM, fn() => Blocks::EYEBLOSSOM()->setOpen(true));
		...
		$this->mapSimple(Ids::RESIN_BLOCK, fn() => Blocks::RESIN_BLOCK());
