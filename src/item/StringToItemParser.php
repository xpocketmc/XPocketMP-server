...
final class StringToItemParser extends StringToTParser{
	...
	private static function registerBlocks(self $result) : void{
		...
		$result->registerBlock("pale_oak_button", fn() => Blocks::OAK_BUTTON());
		$result->registerBlock("pale_oak_door", fn() => Blocks::OAK_DOOR());
		$result->registerBlock("pale_oak_door_block", fn() => Blocks::OAK_DOOR());
		$result->registerBlock("pale_oak_fence", fn() => Blocks::OAK_FENCE());
		$result->registerBlock("pale_oak_fence_gate", fn() => Blocks::OAK_FENCE_GATE());
		$result->registerBlock("pale_oak_leaves", fn() => Blocks::OAK_LEAVES());
		$result->registerBlock("pale_oak_log", fn() => Blocks::OAK_LOG()->setStripped(false));
		$result->registerBlock("pale_oak_planks", fn() => Blocks::OAK_PLANKS());
		$result->registerBlock("pale_oak_pressure_plate", fn() => Blocks::OAK_PRESSURE_PLATE());
		$result->registerBlock("pale_oak_sapling", fn() => Blocks::OAK_SAPLING());
		$result->registerBlock("pale_oak_sign", fn() => Blocks::OAK_SIGN());
		$result->registerBlock("pale_oak_slab", fn() => Blocks::OAK_SLAB());
		$result->registerBlock("pale_oak_stairs", fn() => Blocks::OAK_STAIRS());
		$result->registerBlock("pale_oak_standing_sign", fn() => Blocks::OAK_SIGN());
		$result->registerBlock("pale_oak_trapdoor", fn() => Blocks::OAK_TRAPDOOR());
		$result->registerBlock("pale_oak_wall_sign", fn() => Blocks::OAK_WALL_SIGN());
		$result->registerBlock("pale_oak_wood", fn() => Blocks::OAK_WOOD()->setStripped(false));
		$result->registerBlock("pale_oak_wood_stairs", fn() => Blocks::OAK_STAIRS());
		$result->registerBlock("pale_oak_wooden_stairs", fn() => Blocks::OAK_STAIRS());
