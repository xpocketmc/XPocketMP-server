...
final class StringToItemParser extends StringToTParser{
	...
	private static function registerBlocks(self $result) : void{
		...
		$result->registerBlock("closed_eyeblossom", fn() => Blocks::EYEBLOSSOM());
		...
		$result->registerBlock("creaking_heart", fn() => Blocks::CREAKING_HEART());
		...
		$result->registerBlock("open_eyeblossom", fn() => Blocks::EYEBLOSSOM()->setOpen(true));
		...
		$result->registerBlock("pale_oak_door_block", fn() => Blocks::PALE_OAK_DOOR());
		...
		$result->registerBlock("pale_oak_standing_sign", fn() => Blocks::PALE_OAK_SIGN());
		$result->registerBlock("pale_oak_trapdoor", fn() => Blocks::PALE_OAK_TRAPDOOR());
		$result->registerBlock("pale_oak_wall_sign", fn() => Blocks::PALE_OAK_WALL_SIGN());
		$result->registerBlock("pale_oak_wood", fn() => Blocks::PALE_OAK_WOOD()->setStripped(false));
		$result->registerBlock("pale_oak_wood_stairs", fn() => Blocks::PALE_OAK_STAIRS());
		$result->registerBlock("pale_oak_wooden_stairs", fn() => Blocks::PALE_OAK_STAIRS());
