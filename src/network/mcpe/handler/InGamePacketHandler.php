...
use XPocketMPlock\tile\Sign;
use XPocketMPlock\utils\SignText;
use XPocketMP\entity\animation\ConsumingItemAnimation;
use XPocketMP\entity\Attribute;
use XPocketMP\entity\InvalidSkinException;
use XPocketMP\event\player\PlayerEditBookEvent;
...
use XPocketMP\item\WritableBook;
use XPocketMP\item\WritableBookPage;
use XPocketMP\item\WrittenBook;
